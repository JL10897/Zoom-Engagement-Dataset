...
| 5. **Unchanged Shared Screen recording**| Share screen | Splitted from 1 (share_screen.mp4) using [Time Stamp Spreadsheet](https://docs.google.com/spreadsheets/d/1pYKqmghlGIbarUW7rUkTX_hiaAkYlV_0R-ExDdXn0_c/edit#gid=0) ||
...
| 7. [**10-Second contextual recording**](https://drive.google.com/drive/folders/1OiT_cTSnfhF_PQ5bR3oGt0XUJs8D4-CF?usp=share_link)| Share screen, student, lecturer | Combined 4 with 6  |In "cropped video", find each lecture folder; in each lecture folder, find the "final folder|
